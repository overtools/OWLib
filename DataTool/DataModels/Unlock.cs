...
namespace DataTool.DataModels {
    ...
    public static class UnlockData {
        public static readonly Dictionary<string, ulong[]> CuratedGUID = new Dictionary<string, ulong[]> {
            ...
            { "anniversary2018", new ulong[] {
            } },
            { "anniversary2017", new ulong[] {
            } },
            { "archives2018", new ulong[] {
            } },
            { "archives2017", new ulong[] {
            } },
            { "halloween2017", new ulong[] {
            } },
            { "halloween2016", new ulong[] {
            } },
            { "winter2017", new ulong[] {
            } },
            { "winter2016", new ulong[] {
            } },
            { "lunar2018", new ulong[] {
            } },
            { "lunar2017", new ulong[] {
