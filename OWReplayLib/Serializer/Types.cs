...
namespace OWReplayLib.Serializer {
    public class Types {
        ...
        public class Magic : IReadableType {
            protected uint Expected;
            protected Type Type;

            public Magic(uint expected) {
                Expected = expected;
            }
            
            public override object Read(BinaryReader reader, FieldInfo field) {
                uint thisMagic = reader.ReadUInt32();
                if (thisMagic != Expected) {
                    throw new InvalidDataException($"Magic was invalid (got: {thisMagic:X}, expected: {Expected:X})");
                }
                return thisMagic;
            }
        ...
        public class Magic24 : Magic {
            public override object Read(BinaryReader reader, FieldInfo field) {
                uint thisMagic = reader.ReadUInt24();
                if (thisMagic != Expected) {
                    throw new InvalidDataException($"Magic was invalid (got: {thisMagic:X}, expected: {Expected:X})");
                }
                return thisMagic;
            ...
            public Magic24(uint expected) : base(expected) { }
