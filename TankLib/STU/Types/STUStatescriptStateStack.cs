...
namespace TankLib.STU.Types
{
    ...
    public class STUStatescriptStateStack : STUStatescriptState
    {
        ...
        [STUField(0xD3116304, 216, ReaderType = typeof(EmbeddedInstanceFieldReader))] // size: 8
        public STU_904BFCEC m_topSubgraphPlug;

        [STUField(0xC72FEA39, 224, ReaderType = typeof(EmbeddedInstanceFieldReader))] // size: 8
        public STU_904BFCEC m_underSubgraphPlug;

        [STUField(0x91FED9B3, 232)] // size: 1
